...
start_install() {
    ...
    if [ $GIT_INSTALL = true ]; then
        ...
        sudo -u www-data git clone https://github.com/thovdamm/photobooth $INSTALLFOLDER
        cd $INSTALLFOLDERPATH
        add_git_remote
        start_git_install
    else
        ...
        sudo -u www-data curl -s https://api.github.com/repos/thovdamm/photobooth/releases/latest |
